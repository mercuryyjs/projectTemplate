...
(function () {
    ...
    //var origin = window.location.origin.replace(/9081/,'9082');
    var origin = baseUrl;
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        , serverUrl: origin+'/psp-management/controller.jsp'
        ...
        , toolbars: [[
            ...
            'directionalityltr', 'directionalityrtl', 'indent', '|','simpleupload',
        ...
        //    'anchor':'', 'undo':''
        //}
        ,enableDragUpload: true//启动拖拽
        ,imageScaleEnabled: false//禁止图片缩放
        ,imagePopup:true
